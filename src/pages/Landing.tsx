      ...
      <section className="container mx-auto px-6 py-24 md:py-32">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-6 text-lg text-muted-foreground">
            Chatbot, Agent, Memory, Portal and Admin — a complete system to
            build, run and govern AI assistants for your organization.
          </p>
      ...
      <section className="border-t border-border">
        <div className="container mx-auto flex flex-col items-center px-6 py-20 text-center">
          ...
          <p className="mt-3 max-w-xl text-muted-foreground">
            Sign in to access the chat experience and start building with the
            platform.
          </p>
          <div className="mt-8">
            <LoginButton />
